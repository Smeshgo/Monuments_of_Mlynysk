...
const GallerySingle = () => {
    ...
    useEffect(() => {
        fetch('https://localhost:44352/home/Singlimg', {
            headers: {
                ...
                <SRLWrapper options={options}>
                    <div className="content">
                        <Grid justify="flex-start"
                            ...
                            {/*    ))*/}
                            {/*    : 'Loading'}*/}
                            <img src="https://localhost:44352/src/assets/images/Img/Single/mini/om1.jpg" alt="#1"/>
                                    ...
                                    <Box display={'flex'} justifyContent="center">
                                        <Box className={classes.image}>
                                            ...
                                            <LazyLoad
                                                ...
                                                <a href={`./../../assets/images/${img.pathFull}`}>
                                                    <img src={`./../../assets/images/${img.pathMini}`} alt={`#${i + 1}`}/>
                                                    <div className={classes.imageText}>#{i + 1}</div>
                                                </a>
                                            </LazyLoad>
                                        </Box>
